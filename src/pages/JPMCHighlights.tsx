...
const JPMCHighlights = () => {
  ...
  return (
    <div className="min-h-screen bg-[#000000] jpmc-container">
      <Header />

      <main className="container mx-auto px-24 pt-32 pb-48">
        {/* <Link 
          to="/" 
        ...
        <h1
          ...
          className="manrope-800-spaced pb-12 center"
        >
          JPMC Highlights
        </h1>
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          <section className="space-y-6">
            <h2 className="text-xl font-semibold mb-4 text-white manrope-600">
              Stock Price (Last {stockPriceDays} Days)
            </h2>
            ...
            {showDividendAnalysis && !isDividendLoading && (
              <div className="pt-10">
                <h2 className="text-xl font-semibold mb-4 text-white manrope-600">JPMC Dividend History</h2>
                <div className="p-6 bg-[#141414] rounded-lg border border-[#333333] shadow-sm">
                  <DividendChart />
                </div>
              </div>
          ...
          {showCEOCommentary && (
            <section>
              <CEOCommentary commentary={ceoCommentaryQ32024} onClose={handleCloseCEOCommentary} />
            </section>
          )}
        </div>
      </main>
