      ...
      <main className="container mx-auto px-24 pt-32 pb-48">
        ...
        >
          ...
          Back to Home
				...
				<h1 style={{textAlign: "center", fontSize: "36px", fontWeight: "bold"}} className="manrope-800-spaced pb-12 center">JPMC Highlights</h1>
        
        <div className="max-w-4xl mx-auto space-y-8">
          <section className="space-y-6">
              <h2 className="text-xl font-semibold mb-4 text-white manrope-600">Stock Price (Last {stockPriceDays} Days)</h2>
